...
func (s *Simulation) reconcilePersistentWallSpringContacts() {
	...
	for range 4 {
		if !s.reconcilePersistentWallSpringContactPass(heatedContacts) {
			return
		}
	}
}

func (s *Simulation) reconcilePersistentWallSpringContactPass(heatedContacts map[persistentWallSpringContactID]bool) bool {
	reconciled := false
	for _, spring := range s.Springs {
		...
		for i := range s.Masses {
			if s.shouldApplyWallSpringCollision(i, aIndex, bIndex) {
				...
				contactReconciled := s.reconcilePersistentWallSpringContact(spring, &s.Masses[i], &s.Masses[aIndex], &s.Masses[bIndex], applyTemperature)
				reconciled = contactReconciled || reconciled
				recordHeatedPersistentWallSpringContact(heatedContacts, contactID, spring, contactReconciled)
			}
		}
	}
	return reconciled
...
func recordHeatedPersistentWallSpringContact(heatedContacts map[persistentWallSpringContactID]bool, contactID persistentWallSpringContactID, spring Spring, contactReconciled bool) {
	if contactReconciled && spring.Temperature > 0 {
...
// {"version":1,"tested_at":"2026-05-23T12:08:20-05:00","module_hash":"37edbf8bdf32123a1c94125f9502666c982f86bd8cd14bf7167b6a95a5066697","functions":[{"id":"func/Simulation.applyMassCollisions","name":"Simulation.applyMassCollisions","line":7,"end_line":19,"hash":"5379009637bed15470b5620c7ac9404b7f9365f20d5f79bb612186bc72112cff"},{"id":"func/firstCollisionPartnerIndex","name":"firstCollisionPartnerIndex","line":21,"end_line":23,"hash":"c1b7d5bed0f8810a1fc6b5eff3c2c8e2fe0c00728efb59331a2a798357d75cc7"},{"id":"func/Simulation.applyMassCollision","name":"Simulation.applyMassCollision","line":25,"end_line":38,"hash":"586096d3e011ee19bee0d952e16ac54bdd38a02321ff92dc20c7ab567a5db1c4"},{"id":"func/Simulation.applyPostContactReconciliation","name":"Simulation.applyPostContactReconciliation","line":40,"end_line":47,"hash":"40ed6cc2b9922562f5a2fbf4158cd4466cb0dff2798b142f79a37e7ac64bf77a"},{"id":"func/Simulation.reconcileEnabledWallContacts","name":"Simulation.reconcileEnabledWallContacts","line":49,"end_line":53,"hash":"f5c7c1a0af9ef6b8f1d765e7031c4839811fd8f97d5d5ef493496e3218a72f93"},{"id":"func/Simulation.reconcileEnabledWallContact","name":"Simulation.reconcileEnabledWallContact","line":55,"end_line":67,"hash":"c0617351550baf11fbded0df025afe977ac22084362d02e26d875f0edf4195fc"},{"id":"func/Simulation.reconcilePersistentWallSpringContacts","name":"Simulation.reconcilePersistentWallSpringContacts","line":69,"end_line":76,"hash":"f7e7fc296b921d2bd67f5316e93ec8226c468f007645c8dd7395aa61c85f8520"},{"id":"func/Simulation.reconcilePersistentWallSpringContactPass","name":"Simulation.reconcilePersistentWallSpringContactPass","line":78,"end_line":96,"hash":"e0d9c4db9176187d13a0825f404310381e97217db34fb882cb9dbdd2dbbec2bf"},{"id":"func/recordHeatedPersistentWallSpringContact","name":"recordHeatedPersistentWallSpringContact","line":103,"end_line":107,"hash":"4827140226041c105c7154118237825a285bab862e84b1bf0d587d9a34e910ed"},{"id":"func/Simulation.reconcilePersistentWallSpringContact","name":"Simulation.reconcilePersistentWallSpringContact","line":109,"end_line":125,"hash":"804c21ce45ae74172a381d82d1d34f4f5fd344eb4a4743751f3a93eb4e825cb4"},{"id":"func/persistentWallSpringContactFor","name":"persistentWallSpringContactFor","line":133,"end_line":158,"hash":"7e00d5f9a6e7f650fc0eaf002394f838d48e5d5340c195eced6927969b024b96"},{"id":"func/applyPersistentWallSpringPositionCorrection","name":"applyPersistentWallSpringPositionCorrection","line":160,"end_line":170,"hash":"cc43dc72b053c563069f06ef9503c5bab3ff02280ea3118ea69d41ba707d5593"},{"id":"func/resolvePersistentWallSpringVelocity","name":"resolvePersistentWallSpringVelocity","line":172,"end_line":187,"hash":"196e5c223e7e36c466964d421d751f3c08c14f5faa57a4e2f6978060929496e7"},{"id":"func/Simulation.applyPersistentWallSpringTemperatureKick","name":"Simulation.applyPersistentWallSpringTemperatureKick","line":189,"end_line":196,"hash":"4362c99ff343ecd47dbf5e6600ccbc81a9a14b91b6229aeec008fc5d479ac6c6"},{"id":"func/wallSpringContactSharesAndInverseMass","name":"wallSpringContactSharesAndInverseMass","line":198,"end_line":203,"hash":"bd64f5dd1db1f7a51d3cdc8be9d498c5c4774f89d331ef4d022ff658df8950d0"},{"id":"func/collisionGeometryFor","name":"collisionGeometryFor","line":213,"end_line":226,"hash":"4aede77bbffb3a3ab973a50e3fd867499c9ddb09ccc28a0622f0061ea6381f72"},{"id":"func/collisionVelocitiesSeparating","name":"collisionVelocitiesSeparating","line":228,"end_line":231,"hash":"f52eae3df0f4825de2a2a3752b1426b6cd90fd6013b578e79d862ac13258adc8"},{"id":"func/axisVelocitiesSeparating","name":"axisVelocitiesSeparating","line":233,"end_line":242,"hash":"b97093dba711234b832aed6df9635b9bfe47361bd9463f57ad1defd61ceb89c8"},{"id":"func/collisionGeometry.avoidVerticalDivision","name":"collisionGeometry.avoidVerticalDivision","line":244,"end_line":248,"hash":"88cccca7591ad7afa29e256d09bfd500d8b8c686cb0ffa3ce77e5ac229a59223"},{"id":"func/applyCollisionVelocity","name":"applyCollisionVelocity","line":250,"end_line":259,"hash":"cf26b30421af198e20ff169771094969463810af774fc1f6d74b3a488f503d7a"},{"id":"func/collisionRatio","name":"collisionRatio","line":261,"end_line":267,"hash":"95d5ae0e55e9f5b6c3190e99f44d99369e80ac845a32f82a654401b73a2e5249"},{"id":"func/effectiveCollisionMass","name":"effectiveCollisionMass","line":269,"end_line":274,"hash":"7e5e2a521ed0f604789ebf8219cc8ea5c730429b3fe678868b30bba111ed9684"},{"id":"func/MassRadius","name":"MassRadius","line":276,"end_line":282,"hash":"3c4415b5dbb666c2192df8b4cd5b580f0565990797c35d6d435ab4f5ccc12bf5"},{"id":"func/Simulation.applyWallSpringLengthConstraints","name":"Simulation.applyWallSpringLengthConstraints","line":284,"end_line":292,"hash":"cd0994a247581d6d0df5eb492a8ee281c663a852dfe022a5afe6abdb9b306047"},{"id":"func/Simulation.applyWallSpringLengthConstraint","name":"Simulation.applyWallSpringLengthConstraint","line":294,"end_line":306,"hash":"69e9c99ad19cb2f2119459db1a2def881885636deca5f1f77768038aa11241d1"},{"id":"func/applyWallSpringLengthCorrection","name":"applyWallSpringLengthCorrection","line":308,"end_line":316,"hash":"c81a1c26d3cd3e42494e73d9d4538961ebc4d07e5f6902cd65b270a89334c720"},{"id":"func/moveSingleFixedWallSpringEndpoint","name":"moveSingleFixedWallSpringEndpoint","line":318,"end_line":328,"hash":"cf307e561279f4f910053f4208f243b1a6d908804a569a8d859b94a06e2f28f3"},{"id":"func/shareWallSpringLengthCorrection","name":"shareWallSpringLengthCorrection","line":330,"end_line":334,"hash":"5cbb079415ee5f840a5981b686cfae5c6a33d8399b519e4284cdaff5121d44df"},{"id":"func/moveWallSpringEndpoint","name":"moveWallSpringEndpoint","line":336,"end_line":338,"hash":"5e8f1b7531c4f9654853aa109b55300084da6b08a3b5a1cf4933baca94066b93"},{"id":"func/Simulation.applyWallSpringLengthConstraintCollisions","name":"Simulation.applyWallSpringLengthConstraintCollisions","line":340,"end_line":352,"hash":"29ed684c7db0d608d5651c5c6af6707841c7f00618ff05e8a8753533729f876f"},{"id":"func/Simulation.applyWallSpringEndpointConstraintCollisions","name":"Simulation.applyWallSpringEndpointConstraintCollisions","line":354,"end_line":371,"hash":"a1cbb464d5e83903c68ee16c0a3fb52cfb437f3cda01078609bc9a3a530f3256"},{"id":"func/Simulation.applyWallSpringCollisions","name":"Simulation.applyWallSpringCollisions","line":373,"end_line":392,"hash":"4939345a937b1f8ea555e60beeec9ba010e7b360ec188af95f57e7dd5a661044"},{"id":"func/wallSpringBoundaryStartPenetrating","name":"wallSpringBoundaryStartPenetrating","line":394,"end_line":417,"hash":"143505257f7ece79e82099e481d6d0fea85714569943483a355ed568b1228ca1"},{"id":"func/Simulation.applyMovingWallSpringFixedEndpointCollisions","name":"Simulation.applyMovingWallSpringFixedEndpointCollisions","line":419,"end_line":430,"hash":"c9d68269daafeb253406edbc9a03eca2f22483a47694bde50d30708144845017"},{"id":"func/Simulation.movingWallSpringEndpointIndexes","name":"Simulation.movingWallSpringEndpointIndexes","line":432,"end_line":435,"hash":"b76c648217919a1005485e6258d3bae16006545b064aafb61ba02d5e4952d3f2"},{"id":"func/Simulation.applyMovingWallSpringAgainstFixedEndpoints","name":"Simulation.applyMovingWallSpringAgainstFixedEndpoints","line":437,"end_line":449,"hash":"20dd250ec3e631f61e3ee0647a66560dff90fae27dd890982075a97f474a1c15"},{"id":"func/Simulation.applyMovingWallSpringFixedEndpointCollision","name":"Simulation.applyMovingWallSpringFixedEndpointCollision","line":451,"end_line":471,"hash":"8c14e4cbc53a198ec902c7695619607b8f4b942ed7c5e6c196b5e9f9716cb073"},{"id":"func/Simulation.skipMovingWallSpringFixedEndpointCollision","name":"Simulation.skipMovingWallSpringFixedEndpointCollision","line":473,"end_line":475,"hash":"649d071e2e14b1e073a7f0a1bb9fe60f89e50a61e718904fe5ccf53a183976bc"},{"id":"func/fixedEndpointContactOutside","name":"fixedEndpointContactOutside","line":477,"end_line":479,"hash":"35d44904cfcafb83c4cbcf1c057a76cfcb7aed7d515f4bbccd566c3cc23263ba"},{"id":"func/fixedEndpointContactResolved","name":"fixedEndpointContactResolved","line":481,"end_line":483,"hash":"3862639c14152150c5a830cbbd1d32173547c107e239aee4aa2b6db630aeb24b"},{"id":"func/Simulation.movingWallSpringFixedEndpointContact","name":"Simulation.movingWallSpringFixedEndpointContact","line":485,"end_line":492,"hash":"98218cf33adaf0bba14b1e47a31abafe52fa2648e2116304b99f13ef4d7143af"},{"id":"func/Simulation.previousFixedEndpointNormal","name":"Simulation.previousFixedEndpointNormal","line":494,"end_line":505,"hash":"2ad30017dadb2a6f75b8f1bf0dd2c37ff1a2014125565d151299e70999326fe2"},{"id":"func/currentFixedEndpointContact","name":"currentFixedEndpointContact","line":507,"end_line":516,"hash":"ec63a745ef481f81dc9ab214f6e79dee2f6ccff66ac9c903a2e32f21661d3b00"},{"id":"func/closestFractionOnSegment","name":"closestFractionOnSegment","line":518,"end_line":521,"hash":"d1edeb9d58e93dce9aa32398ae0bc9c30686a024027c87e29d16cb9f0b01eb69"},{"id":"func/resolvedFixedEndpointContactVelocity","name":"resolvedFixedEndpointContactVelocity","line":523,"end_line":526,"hash":"9599dc47df7f4e9233d8ed61207791ac9912134ee8f31464bc81a759a073c29f"},{"id":"func/shareMovingWallSpringContactImpulse","name":"shareMovingWallSpringContactImpulse","line":528,"end_line":538,"hash":"253914751bba2bea264fe4171bd9b6b6755a4469e06a116c7f223d9c2e699c62"},{"id":"func/contactShareInverseMass","name":"contactShareInverseMass","line":540,"end_line":545,"hash":"d98368a0621e77fbfd24b471bb70bf770769a4d1607d7dac51cde0709a556fea"},{"id":"func/wallSpringPreviousPosition","name":"wallSpringPreviousPosition","line":547,"end_line":552,"hash":"6a4a9c259c5c91ba2f9d51348efd5f84ce96e1b3b4600e82e4a9da5e1da884fd"},{"id":"func/Simulation.wallSpringEndpointIndexes","name":"Simulation.wallSpringEndpointIndexes","line":554,"end_line":559,"hash":"307c5660a27649ce403eb5e9d332f81c5f8b5cae817b8b743b9150bcfc573d14"},{"id":"func/Simulation.shouldApplyWallSpringCollision","name":"Simulation.shouldApplyWallSpringCollision","line":561,"end_line":563,"hash":"fc1ed28fe790afac15224ddfe7c361fd41b4627bb2be61cf2ffd4c60eb5a5702"},{"id":"func/Simulation.springEndpointIndexes","name":"Simulation.springEndpointIndexes","line":565,"end_line":572,"hash":"28dc42d1c5041984b51daa62a36bef51c4a6008e2cee3fa5ea814a294348deae"},{"id":"func/Simulation.applyWallSpringCollision","name":"Simulation.applyWallSpringCollision","line":574,"end_line":595,"hash":"879e2b3bf1fc96651ab0e0f35e1b50d31e797acdd0f606fe213857fcb23ab679"},{"id":"func/wallSpringCollisionContact","name":"wallSpringCollisionContact","line":597,"end_line":614,"hash":"9327a22d12499ac39a884685316caec484325cbe60e3c63a1badf8d7af9c17f8"},{"id":"func/wallSpringNormal","name":"wallSpringNormal","line":616,"end_line":622,"hash":"ad94ad425b5345ea5f130fc76c38ad15088db9790b3bc7e696919005d1d489ae"},{"id":"func/wallSpringContactVelocity","name":"wallSpringContactVelocity","line":624,"end_line":626,"hash":"9e4131292f82d473684bafeb206784e8b8de66b5671c8bc3b390e0a7e04efc3c"},{"id":"func/resolveFiniteWallSpringCollision","name":"resolveFiniteWallSpringCollision","line":628,"end_line":643,"hash":"e41155b1461043e4da1208c0fb35392989a7a81c6e5ba22a84237df3321f4fcf"},{"id":"func/finiteWallSpringCollisionSeparating","name":"finiteWallSpringCollisionSeparating","line":645,"end_line":647,"hash":"00562ff41992ace044b29e0ca5c80ac38f522d75815e2f554dca6a60fae938fc"},{"id":"func/Simulation.applyWallSpringTemperatureKick","name":"Simulation.applyWallSpringTemperatureKick","line":649,"end_line":657,"hash":"ee8e22bc2fa3f4adce4a27ae706b5a56f31bfa17e29955aee48c40ca77a35cf2"},{"id":"func/fullScreenGravityKick","name":"fullScreenGravityKick","line":659,"end_line":661,"hash":"b759a6d17df5f312ddc455452e72952a610374c7eec99bac660cb989e900836e"},{"id":"func/wallSpringContactFraction","name":"wallSpringContactFraction","line":663,"end_line":671,"hash":"dc34dee4a0a55dccc7aafe471d69d6079a4eee4fa1da663d72de54f085151058"},{"id":"func/wallSpringCrossingRejected","name":"wallSpringCrossingRejected","line":673,"end_line":681,"hash":"29034c13e7de7e7d99b37d0002e074bac90270988d356188c6cf1254ae72974f"},{"id":"func/wallSpringIntersectionFraction","name":"wallSpringIntersectionFraction","line":683,"end_line":688,"hash":"93e86e1f22a4fe3febfac13940e372715c087ff01970e3ef8d76e626bad43eba"},{"id":"func/sameSign","name":"sameSign","line":690,"end_line":692,"hash":"a4155fc319954816bbce383fa5fa6271ca2370c06ce7d19922bff31573a78cda"},{"id":"func/sideSign","name":"sideSign","line":694,"end_line":699,"hash":"298538937752c7335e7161193cda4a5bd2e05511e0081d1f293bd8376e12c0a2"},{"id":"func/collisionStartSide","name":"collisionStartSide","line":701,"end_line":706,"hash":"8230beac044869aaf2a79e8522c9570cc0a1a079da871d193b86d6bf94bbee14"},{"id":"func/closestPointOnSegment","name":"closestPointOnSegment","line":708,"end_line":711,"hash":"0715cf2350f10592aa42cd7fec2c8d37d91e62e3f5f323d31dbb004a4bec942c"},{"id":"func/resolveWallSpringVelocity","name":"resolveWallSpringVelocity","line":713,"end_line":721,"hash":"468a38cefa849c2f9741e124df5299b9f3f579e640c21b0f68e3bea165b7e85a"},{"id":"func/wallSpringCollisionElasticity","name":"wallSpringCollisionElasticity","line":723,"end_line":728,"hash":"3e14c8f95c00a57b977e4ce3d1ae590122b7ac8dcb5e4fa36f12a41ef123181e"},{"id":"func/wallSpringVelocitySeparating","name":"wallSpringVelocitySeparating","line":730,"end_line":732,"hash":"b289c63f8350c06a397e29480f78e5acf6b505e5ba3e8dad054f8898992e88ff"},{"id":"func/shareWallSpringImpulse","name":"shareWallSpringImpulse","line":734,"end_line":736,"hash":"839395982e4922fb746e85a4d7b558011538ab2168015b2d6de4d9104c51ee8c"},{"id":"func/shareWallSpringPositionCorrection","name":"shareWallSpringPositionCorrection","line":738,"end_line":740,"hash":"5d6fe95616dcbb6f7afe71909ada5bbf4465278b5a0572126c0ffe2f39499b11"},{"id":"func/wallSpringSharedDelta","name":"wallSpringSharedDelta","line":742,"end_line":747,"hash":"2c77eeec33c8a53932a89b745a7abdc4e50bbca1317d1a23869513e6c995f5fc"}]}
