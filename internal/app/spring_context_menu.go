...
func (g *Game) springContextMenuItems() []contextMenuItem {
	if _, ok := g.simulation.SpringByID(g.overlays.springMenu.SpringID); !ok {
		return nil
	}
