...
func (g *Game) updateSpring(id int, update func(*sim.Spring)) {
	updateByIDAndMarkDirty(g, g.world.simulation.Springs, id, func(spring *sim.Spring) int { return spring.ID }, update)
}
