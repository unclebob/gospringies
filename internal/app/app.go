...
func (g *Game) pendingSpringLine() (selectionLine, bool) {
	...
	start, ok := g.simulation.MassByID(g.pointer.pendingSpringID)
	if !ok {
		return selectionLine{}, false
	}
