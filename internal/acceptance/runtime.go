...
type world struct {
	...
	wallSpringEnergy     float64
	wallSpringStep       float64
	fixedEndpointSides   map[int]sim.Vec2
}
...
var stepHandlers = map[string]stepHandler{
	...
	"the mass collision task is accepted":                                                                   acceptStep,
	"a collision world with mass <mass_a> at <x_a>, <y_a> moving <vx_a>, <vy_a>":                            createCollisionMassA,
	"collision mass <mass_a> has mass value <mass_value_a> elasticity <elasticity_a> fixed state <fixed_a>": setCollisionMassAProperties,
	"collision mass <mass_b> at <x_b>, <y_b> moving <vx_b>, <vy_b>":                                         createCollisionMassB,
	"collision mass <mass_b> has mass value <mass_value_b> elasticity <elasticity_b> fixed state <fixed_b>": setCollisionMassBProperties,
	"mass collision is enabled":                                                                             enableMassCollision,
	"the coder advances through mass collision":                                                             advanceThroughMassCollision,
	"collision mass <mass_a> velocity should be <expected_vx_a>, <expected_vy_a>":                           assertCollisionMassAVelocity,
	"collision mass <mass_b> velocity should be <expected_vx_b>, <expected_vy_b>":                           assertCollisionMassBVelocity,
	...
	"mass <mass_id> is near the inside of the <wall> boundary":                                              createMassNearInsideWall,
	...
	"world force <force_name> is configured with <enabled_state> and <force_parameters>":                    configureWorldForce,
	"the coder saves the world as XSP":                                                                      saveXSPWorld,
	"saved XSP output should include force token <force_token>":                                             assertSavedXSPIncludesForceToken,
	"the coder loads XSP input with force token <force_token>":                                              loadXSPInputWithForceToken,
	"loaded force token <force_token> should map to force <force_name>":                                     assertLoadedForceTokenMapsToForce,
	"loaded force <force_name> should be configured with <enabled_state> and <force_parameters>":            assertLoadedForceConfigured,
	...
	"the right panel slider text fields task is accepted":                                                   acceptStep,
	"the coder draws the application frame":                                                                 drawApplicationFrame,
	"the coder renders the right inspector":                                                                 renderRightInspector,
	"numeric setting <setting> should have a visible slider":                                                assertNumericSettingVisibleSlider,
	"numeric setting <setting> should have a visible text field":                                            assertNumericSettingVisibleTextField,
	"numeric setting <setting> text field should show value <value>":                                        assertNumericSettingTextFieldShowsValue,
	"numeric setting <setting> text field should show value <new_value>":                                    assertNumericSettingTextFieldShowsNewValue,
	"every numeric setting label should fit inside the right inspector":                                     assertEveryNumericSettingLabelFitsInspector,
	"every numeric setting slider should fit inside the right inspector":                                    assertEveryNumericSettingSliderFitsInspector,
	"every numeric setting text field should fit inside the right inspector":                                assertEveryNumericSettingTextFieldFitsInspector,
	"numeric setting controls should not overlap other numeric setting controls":                            assertNumericSettingControlsDoNotOverlap,
	"numeric setting controls should not overlap right inspector section headings":                          assertNumericSettingControlsDoNotOverlapHeadings,
	"the coder renders numeric setting <setting>":                                                           renderNumericSetting,
	"numeric setting <setting> label should be left of its slider":                                          assertNumericSettingLabelLeftOfSlider,
	"numeric setting <setting> text field should be right of its slider":                                    assertNumericSettingTextRightOfSlider,
	"numeric setting <setting> slider and text field should be on the same row":                             assertNumericSettingSliderAndTextSameRow,
	"numeric setting <setting> text field should fit value <longest_value>":                                 assertNumericSettingTextFieldFitsValue,
	"the coder changes numeric setting Stick with the slider to <new_value>":                                changeStickWithSlider,
	"parameter stickiness should be <new_value>":                                                            assertParameterValueFromExample,
	"numeric setting Stick text field should show value <new_value>":                                        assertStickTextFieldShowsNewValue,
	"numeric setting <setting> has value <old_value>":                                                       setNumericSettingValue,
	"the coder focuses numeric setting <setting> text field":                                                focusNumericSettingTextField,
	"numeric setting <setting> text field cursor should blink":                                              assertNumericSettingCursorBlinks,
	"the coder enters text value <new_value>":                                                               enterNumericTextValue,
	"numeric setting <setting> should have value <new_value>":                                               assertNumericSettingHasValue,
	"numeric setting <setting> slider should show value <new_value>":                                        assertNumericSettingSliderShowsValue,
	"the coder changes numeric setting <setting> with the slider to <new_value>":                            changeNumericSettingWithSlider,
	"the coder enters text value <final_value>":                                                             enterNumericTextValue,
	"numeric setting <setting> slider should show value <final_value>":                                      assertNumericSettingSliderShowsValue,
	...
	"saved XSP file <old_save_file> exists in saves":                                                        createOldSavedXSPFile,
	...
	"load picker should show <new_save_file> before <separator>":                                            assertNewSaveFileBeforeSeparator,
	...
	"saved XSP file <new_save_file> exists in saves with <world_state>":                                     createNewSavedXSPFileWithState,
	"the coder opens the load picker":                                                                       openLoadPicker,
	"the coder chooses load picker entry <save_file>":                                                       chooseLoadPickerEntry,
	"the coder chooses load picker entry <new_save_file>":                                                   chooseNewLoadPickerEntry,
	...
	"the demo picker should open":                                                                           assertDemoPickerOpen,
