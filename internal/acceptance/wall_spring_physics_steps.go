...
func init() {
	for step, handler := range map[string]stepHandler{
		...
		"mass <mass_id> normal rebound speed should be <expected_rebound_speed>":                                                  assertWallSpringMassReboundSpeed,
		"wall spring <spring_id> should receive collision impulse for rebound speed <expected_rebound_speed>":                     assertWallSpringReboundImpulse,
